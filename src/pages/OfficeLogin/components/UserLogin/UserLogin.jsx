...
const backgroundImage =
  'http://cdn.binghai.site/o_1ccsfjr0f1d94eq01r3j152fonra.jpg';
...
export default class UserLogin extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.refs.form.validateAll((errors, values) => {
      ...
      axios.post('/login/officeLogin', values)
      .then(function (response) {
        if(response.data.status=='SUCCESS'){
          Toast.success('登录成功');
          window.location.href="/#/userContractList";
        }else{
      ...
      <div style={styles.userLogin} className="user-login">
        ...
        <div style={styles.contentWrapper} className="content-wrapper">
          ...
          <div style={styles.formContainer}>
            <h4 style={styles.formTitle}>机构登录</h4>
            ...
            >
              <div style={styles.formItems}>
                <Row style={styles.formItem}>
                  <Col>
                    ...
                    <IceFormBinder name="account" required message="必填">
                      <Input maxLength={20} placeholder="机构账户" />
                    </IceFormBinder>
                  </Col>
                  <Col>
                ...
                <Row style={styles.formItem}>
                  <Col>
                    <IceIcon
                      ...
                      style={styles.inputIcon}
                    />
                    <IceFormBinder name="pass" required message="必填">
                ...
                <Row className="tips" style={styles.tips}>
                  <Link to="/officeReg" style={styles.link}>
                    立即注册
                  </Link>
